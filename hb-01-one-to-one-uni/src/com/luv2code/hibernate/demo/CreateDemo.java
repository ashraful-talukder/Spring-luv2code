...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			// create the objects
			Instructor tempInstrutor = new Instructor("Ashraful", "Talukder", "talukder@gmail.com");
			InstructorDetail tempInstructorDetail = new InstructorDetail("https://youtube.com/ashraful-talukder", "Photography");
